...
import static io.pact.core.model.PathExpressionsKt.PATH_SPECIAL_CHARS
...
class PactBodyBuilder extends GroovyBuilder {
  ...
  def generators = new Generators().addCategory(Category.BODY)
  def mimetype = null
  ...
  private setMatcherAttribute(Matcher value, String attributePath) {
    ...
    if (value.generator) {
      generators.addGenerator(Category.BODY, attributePath, value.generator)
    }
    value.value
  }
