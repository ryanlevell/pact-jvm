...
public class PactDslRequestWithPath extends PactDslRequestBase {
  ...
  PactDslRequestWithPath(ConsumerPactBuilder consumerPactBuilder,
    ...
    public PactDslRequestWithPath body(String body, ContentType contentType) {
      ...
      requestBody = OptionalBody.body(body.getBytes(charset), new io.pact.core.model.ContentType(contentType.toString()));
    ...
    public PactDslRequestWithPath body(Supplier<String> body, ContentType contentType) {
      Charset charset = contentType.getCharset() == null ? Charset.defaultCharset() : contentType.getCharset();
      requestBody = OptionalBody.body(body.get().getBytes(charset), new io.pact.core.model.ContentType(contentType.toString()));
      requestHeaders.put(CONTENT_TYPE, Collections.singletonList(contentType.toString()));
      return this;
    }
    ...
    public PactDslRequestWithPath body(JSONObject body) {
        requestBody = OptionalBody.body(body.toString().getBytes(),
          io.pact.core.model.ContentType.Companion.getJSON());
        if (isContentTypeHeaderNotSet()) {
          ...
          requestBody = OptionalBody.body(body.toString().getBytes(charset),
            new io.pact.core.model.ContentType(contentType.toString()));
        }
        return this;
    }
  ...
  public PactDslRequestWithPath body(BodyBuilder builder) {
    ...
    io.pact.core.model.ContentType contentType = builder.getContentType();
    requestHeaders.put(CONTENT_TYPE, Collections.singletonList(contentType.toString()));
