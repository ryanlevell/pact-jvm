...
import io.pact.consumer.dsl.PactDslRequestWithoutPath;
import io.pact.consumer.dsl.PactDslResponse;
...
public class BaseProviderRule extends ExternalResource {
  ...
  private Map<String, io.pact.core.model.Pact> pacts;
  ...
  public Statement apply(final Statement base, final Description description) {
      return new Statement() {
          ...
          public void evaluate() throws Throwable {
              ...
              Map<String, io.pact.core.model.Pact> pacts = getPacts(pactDef.fragment());
              Optional<io.pact.core.model.Pact> pact;
  ...
  private PactVerificationResult runPactTest(final Statement base, io.pact.core.model.Pact pact, PactFolder pactFolder) {
   ...
   * @param fragment
   */
  protected Map<String, io.pact.core.model.Pact> getPacts(String fragment) {
      if (pacts == null) {
        pacts = new HashMap<>();
          for (Method m: target.getClass().getMethods()) {
              if (JUnitTestSupport.conformsToSignature(m) && methodMatchesFragment(m, fragment)) {
                ...
                if (StringUtils.isEmpty(provider) || this.provider.equals(provider)) {
                      ...
                      try {
                        io.pact.core.model.Pact pact = (io.pact.core.model.Pact)
