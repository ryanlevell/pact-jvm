...
public class PactHttpsProviderRule extends BaseProviderRule {
     ...
     */
    public PactHttpsProviderRule(String provider, String hostInterface, Integer port, PactSpecVersion pactVersion, Object target) {
     ...
     * @param target Target test to apply this rule to.
     */
    public PactHttpsProviderRule(String provider, String host, Integer port, boolean https, PactSpecVersion pactVersion,
                                 Object target) {
     ...
     * @param target Target test to apply this rule to.
     */
    public PactHttpsProviderRule(String provider, PactSpecVersion pactSpecVersion, Object target) {
