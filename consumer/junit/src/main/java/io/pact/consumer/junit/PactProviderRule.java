 ...
 */
public class PactProviderRule extends BaseProviderRule {
     ...
     */
    public PactProviderRule(String provider, String hostInterface, Integer port, PactSpecVersion pactVersion, Object target) {
     ...
     * @param target Target test to apply this rule to.
     */
    public PactProviderRule(String provider, String hostInterface, Integer port, Object target) {
