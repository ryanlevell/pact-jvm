...
import io.pact.consumer.junit.DefaultRequestValues;
import io.pact.consumer.junit.DefaultResponseValues;
...
public class PactProviderWithMultipleFragmentsTest {
    ...
    public void runTestWithFragment2() throws IOException {
        ...
        Assert.assertEquals(new ConsumerClient(mockTestProvider2.getUrl()).getAsMap("/", ""), expectedResponse);
    }
