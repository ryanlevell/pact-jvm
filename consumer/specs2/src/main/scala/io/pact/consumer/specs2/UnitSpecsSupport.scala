...
import io.pact.consumer.{MockHttpServer, PactTestExecutionContext}
import io.pact.core.model.matchingrules.{MatchingRules, MatchingRulesImpl}
import io.pact.core.model.{OptionalBody, PactSpecVersion, ProviderState, Request, RequestResponseInteraction, RequestResponsePact, Response, _}
