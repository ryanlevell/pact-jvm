...
import io.pact.core.model.{RequestResponseInteraction, Pact => PactForConsumer}
import io.pact.provider.scalasupport.HttpClient
import io.pact.provider.scalatest.ProviderDsl.defaultPactDirectory
import io.pact.provider.scalatest.Tags.ProviderTest
import io.pact.provider.{ProviderInfo, ProviderUtils, ProviderVerifier}
